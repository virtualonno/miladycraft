ServerEvents.recipes( event => {
	...
	console.log('Firing Miladycraft CustomBlocks recipes event')

		event.shaped(
		Item.of('kubejs:cream_glazed_terracotta', 4),
		[ 
			'AB ',
			'BA ',
			'   '
		...
		{
			A: 'minecraft:white_glazed_terracotta',
			B: 'minecraft:yellow_glazed_terracotta'
		}
	)
